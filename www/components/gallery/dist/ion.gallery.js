(function(){
  ...
  function ionGallery($ionicPlatform,ionGalleryData) {
    ...
    return {
      ...
      link:link,
      replace:true,
      templateUrl:'components/gallery/templates/gallery.html'
    };
  ...
  function ionSlider($ionicModal,ionGalleryData,$ionicPlatform,$timeout,$ionicScrollDelegate){
    ...
    function link(scope, element, attrs) {
      ...
      scope.loadModal = function(){
        $ionicModal.fromTemplateUrl('components/gallery/templates/slider.html', {
          scope: scope,
          animation: 'fade-in'
        }).then(function(modal) {
          _modal = modal;
